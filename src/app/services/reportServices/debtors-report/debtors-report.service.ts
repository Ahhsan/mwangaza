...
export class DebtorsReportService {
  private URL = ' https://loan-management-solution20191108021340.azurewebsites.net/api/Reports/DebtorsReport';
  private headers =
    {
      "startDate": "2020-01-20T13:45:48.035Z",
      "endDate": "2020-01-20T13:45:48.035Z",
      "pageNumber": 0,
      "pageSize": 25,
      "orderByField": 0,
      "orderBy": 1,
  ...
  constructor(private http: HttpClient) {
    ...
    console.log('Headers of debtors request: ', this.headers);
  }
  getDailyReport() {
